...
* [`src/webapp/`](src/webapp/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/webapp/core.cljs): contains the SPA entry point, `init`
* [`test/webapp/`](test/webapp/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
5. Clone this repo and open a terminal in the `webapp` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/webapp/config.cljs) defaults to `true` in
